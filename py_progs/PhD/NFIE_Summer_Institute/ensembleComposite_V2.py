...
EDITED: Chris Zarzar 10-Oct-2017
Script keeps crashing because of some environment mask issue. I never had this 
on my old computer, so it is either because of something Michael has done
to change the data or something else got changes with the data when I resampled
the HECRAS data, or it justneed to be split up and I am using too much ram. So 
I am going to try splitting up the script.

It still broke at flow velocity 1mph. So I am just going to comment out
everything ahead of that and start it again. I think it winds up
just using too much ram or something. Hm, yeah now it made it to fv 2mph. It 
keeps breaking on mem3 too. 
