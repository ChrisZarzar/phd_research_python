...
outRascomp_fldext = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")

outRascomp_wd_hlfft = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_wd_1ft = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_wd_2ft = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_wd_3ft = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_wd_4ft = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_wd_5ft = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_wd_6ft = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")

outRascomp_fv_1mph = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_fv_2mph = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_fv_4mph = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_fv_6mph = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_fv_8mph = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")

outRascomp_crit_hlf_4 = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_crit_1_4 = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_crit_2_4 = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_crit_hlf_6 = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_crit_1_6 = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_crit_2_6 = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_crit_3_2 = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_crit_4_2 = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_crit_5_1 = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
outRascomp_crit_6_1 = Raster("F:\\NFIE_SI_2016\\groupProject\\postprocessOutput\\rasters\\blankRaster\\blankRaster.tif")
...
outRascomp_fldext.save(outPathras+"rasComp_fldext.tif")

outRascomp_wd_hlfft.save(outPathras+"rasComp_wd_hlfft.tif")
outRascomp_wd_1ft.save(outPathras+"rasComp_wd_1ft.tif")
outRascomp_wd_2ft.save(outPathras+"rasComp_wd_2ft.tif")
outRascomp_wd_3ft.save(outPathras+"rasComp_wd_3ft.tif")
outRascomp_wd_4ft.save(outPathras+"rasComp_wd_4ft.tif")
outRascomp_wd_5ft.save(outPathras+"rasComp_wd_5ft.tif")
outRascomp_wd_6ft.save(outPathras+"rasComp_wd_6ft.tif")

outRascomp_fv_1mph.save(outPathras+"rasComp_fv_1mph.tif")
outRascomp_fv_2mph.save(outPathras+"rasComp_fv_2mph.tif")
outRascomp_fv_4mph.save(outPathras+"rasComp_fv_4mph.tif")
outRascomp_fv_6mph.save(outPathras+"rasComp_fv_6mph.tif")
outRascomp_fv_8mph.save(outPathras+"rasComp_fv_8mph.tif")

outRascomp_crit_hlf_4.save(outPathras+"rasComp_crit_hlf_4.tif")
outRascomp_crit_1_4.save(outPathras+"rasComp_crit_1_4.tif")
outRascomp_crit_2_4.save(outPathras+"rasComp_crit_2_4.tif")
outRascomp_crit_hlf_6.save(outPathras+"rasComp_crit_hlf_6.tif")
outRascomp_crit_1_6.save(outPathras+"rasComp_crit_1_6.tif")
outRascomp_crit_2_6.save(outPathras+"rasComp_crit_2_6.tif")
outRascomp_crit_3_2.save(outPathras+"rasComp_crit_3_2.tif")
outRascomp_crit_4_2.save(outPathras+"rasComp_crit_4_2.tif")
outRascomp_crit_5_1.save(outPathras+"rasComp_crit_5_1.tif")
outRascomp_crit_6_1.save(outPathras+"rasComp_crit_6_1.tif")

#Divide each composite raster by the count to get the percent agreement 
outRas1 = outRascomp_fldext/count1

outRas2 = outRascomp_wd_hlfft/count2
outRas3 = outRascomp_wd_1ft/count3
outRas4 = outRascomp_wd_2ft/count4
outRas5 = outRascomp_wd_3ft/count5
outRas6 = outRascomp_wd_4ft/count6
outRas7 = outRascomp_wd_5ft/count7
outRas8 = outRascomp_wd_6ft/count8

outRas9 = outRascomp_fv_1mph/count9
outRas10 = outRascomp_fv_2mph/count10
outRas11 = outRascomp_fv_4mph/count11
outRas12 = outRascomp_fv_6mph/count12
outRas13 = outRascomp_fv_8mph/count13

outRas14 = outRascomp_crit_hlf_4/count14
outRas15 = outRascomp_crit_1_4/count15
outRas16 = outRascomp_crit_2_4/count16
outRas17 = outRascomp_crit_hlf_6/count17
outRas18 = outRascomp_crit_1_6/count18
outRas19 = outRascomp_crit_2_6/count19
outRas20 = outRascomp_crit_3_2/count20
outRas21 = outRascomp_crit_4_2/count21
outRas22 = outRascomp_crit_5_1/count22
outRas23 = outRascomp_crit_6_1/count23
