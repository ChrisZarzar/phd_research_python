...
outRascomp_fldext = Raster(rasDir+outRasfldext)*0

outRascomp_wd_hlfft = Raster(rasDir+outRasfldext)*0
outRascomp_wd_1ft = Raster(rasDir+outRasfldext)*0
outRascomp_wd_2ft = Raster(rasDir+outRasfldext)*0
outRascomp_wd_3ft = Raster(rasDir+outRasfldext)*0
outRascomp_wd_4ft = Raster(rasDir+outRasfldext)*0
outRascomp_wd_5ft = Raster(rasDir+outRasfldext)*0
outRascomp_wd_6ft = Raster(rasDir+outRasfldext)*0

outRascomp_fv_1mph = Raster(rasDir+outRasfldext)*0
outRascomp_fv_2mph = Raster(rasDir+outRasfldext)*0
outRascomp_fv_4mph = Raster(rasDir+outRasfldext)*0
outRascomp_fv_6mph = Raster(rasDir+outRasfldext)*0
outRascomp_fv_8mph = Raster(rasDir+outRasfldext)*0

outRascomp_crit_hlf_4 = Raster(rasDir+outRasfldext)*0
outRascomp_crit_1_4 = Raster(rasDir+outRasfldext)*0
outRascomp_crit_2_4 = Raster(rasDir+outRasfldext)*0
outRascomp_crit_hlf_6 = Raster(rasDir+outRasfldext)*0
outRascomp_crit_1_6 = Raster(rasDir+outRasfldext)*0
outRascomp_crit_2_6 = Raster(rasDir+outRasfldext)*0
outRascomp_crit_3_2 = Raster(rasDir+outRasfldext)*0
outRascomp_crit_4_2 = Raster(rasDir+outRasfldext)*0
outRascomp_crit_5_1 = Raster(rasDir+outRasfldext)*0
outRascomp_crit_6_1 = Raster(rasDir+outRasfldext)*0
