...
imgDir = "E:\\CIR_UAS_Imagery\\Original_CIR_Images\\"
tempDir = "C:\\cmzarzar\\NGI_UAS\\GIS\\Temporary\\"

siteImgList = open("C:\\cmzarzar\\NGI_UAS\\GIS\\Data_Extraction_Dash\\sampleSites_assocaitedImage_ALL.csv", 'r')
