...
env.workspace = "C:\\cmzarzar\\NGI_UAS\\GIS\\Sample_Site_Geodatabases\\SBA_December_2015.gdb"

# Set local variables
bufDir = "H:\\Desktop\\BufferTest\\"
...
"""
# ADD THE BELOW SCRIPT TO LOOP THROUGH ALL GEODATABASES
...
# List features in the wokring geodatabase
...
"""
##---------------------------------------------------------------------------
##START SECOND PART OF SCRIPT: IMAGE EXTRACTION
##---------------------------------------------------------------------------
