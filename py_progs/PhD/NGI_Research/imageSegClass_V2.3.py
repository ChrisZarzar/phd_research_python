...
__date__ = "$Date: 2016/09/15 18:33:00 $"[7:-2]
...
EDITED: Chris Zarzar 15-Sep-2016
This is a complete revamping of the script. This
version is purely Python, no ArcPy. It uses the 
scikit-learn and sckit-image to do the segementations
and the classification. This is nice because I can 
do a comparison of many difference classifiers. 
More information about where I adopted the script is 
at the end of the script.
This method did not work because it keeps running 
out of memory.
...
## Only need this section if I want to set up script to execute from command line using: $ python superpixel.py --image [PATHTOIMAGE]
...
img = img_as_float(io.imread("C:\\cmzarzar\\CIR_UAS_Imagery\\BVSubsets\\Aug_2015_SmallSubset.tif"))
...
#plt.tight_layout()
#plt.show()
plt.imsave("C:\\cmzarzar\\CIR_UAS_Imagery\\BVSubsets\\Aug_2015_SmallSubset_test.tif", segments_slic)


"""
Retrieved from :http://scikit-image.org/docs/dev/auto_examples/plot_segmentations.html
====================================================
