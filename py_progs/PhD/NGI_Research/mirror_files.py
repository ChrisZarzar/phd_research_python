...
Purpose: This tool can be used to mirror files from a source 
directory to a destination directory. You can specify one file using 
`destination` and `source` or definemany files using `source_map` 
(a csv with source,destination file per line).

Notes: This tool was copied from Matt Snider who
created the tool and shared on GitHub. You can find more 
information about it here: 
https://gist.github.com/mattsnider/5862155
http://mattsnider.com/python-script-for-automatically-copying-modified-files/


-----
ADOPTED: Chris Zarzar 10-25-16
